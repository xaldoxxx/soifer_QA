...
class PageItems:
    ...
    def click_colors(self, number):
        ...
        #self.driver.find_elements_by_class_name(*self.colorcheck)[number].click() #opcional
        #self.driver.find_element(*(By.XPATH, '//*[text()="Beige"]')).click()  # buscamos por texto
        #xp = '//*[text()="'+color+'"]'   # optimizo lo anterior
