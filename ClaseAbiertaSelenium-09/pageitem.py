...
# Creamos un metodo q nos devuelva el nro q esta dentro de nuestro cuadro de texto
# el metodo .get_attribute('value')   trae el valor de nuestro cuadro
# .get_attribute sirve para extraer cualquier atributo (en este caso es un value) segun lo q quiera extraer....
